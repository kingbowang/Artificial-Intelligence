...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        # iterate through all legal actions and calculate the q value using getQvalue fucntion
    ...
    def computeActionFromQValues(self, state):
        ...
        for legalAction in self.getLegalActions(state):
            ...
            if selected_action is None or Q_value > Max:
                Max = Q_value
    ...
    def getAction(self, state):
        ...
        # randomly pick an action from the legal action list
    ...
    def update(self, state, action, nextState, reward):
        ...
        self.values[(state, action)] = Q_Value + self.alpha * (
                reward + self.discount * self.computeValueFromQValues(nextState) - Q_Value)
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        # calculate the difference based on the equation given in the assignment page
