...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def runValueIteration(self):
        ...
        while current_iteration < self.iterations:
            # set up the temporary action_value dictionary
    ...
    def computeQValueFromValues(self, state, action):
        ...
        for next_state, probability in self.mdp.getTransitionStatesAndProbs(state, action):
            ...
            # calculate the value of times the discount rate
    ...
    def computeActionFromValues(self, state):
        ...
        # iterate through all possible actions and calculate the q value using computeQValueFromValues function
        for action in self.mdp.getPossibleActions(state):
        ...
        # if the select section is still none, return the last possible action
